local T = { 'craftzdog/solarized-osaka.nvim' }

T.config = function()
    local floatstyle = 'transparent'
    if vim.g.neovide then floatstyle = 'dark' end
    ...
    require('solarized-osaka').setup {
        ...
        styles = {
            ...
            floats = floatstyle, -- style for floating windows
        },
