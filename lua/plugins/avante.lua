...
--`copilot.temperature` should be placed in `providers.copilot.extra_request_body.temperature`; for detailed migration instructions, please visit: https://github.com/yetone/a
-- [DEPRECATED] The configuration of `copilot.max_tokens` should be placed in `providers.copilot.extra_request_body.max_tokens`;
return {
    {
