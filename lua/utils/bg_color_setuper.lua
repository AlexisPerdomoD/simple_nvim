-- local M = {}
-- M.is_bg_transparent = false
-- M.is_floating_transparent = false
--
-- ---@param disable_bg_color boolean
-- ---@param disable_float_bg_color boolean
-- function M:bg_setuper(disable_bg_color, disable_float_bg_color)
--     M.is_floating_transparent = not disable_float_bg_color
--     M.is_bg_transparent = not disable_bg_color
--
...
--     self.is_bg_transparent = not self.is_bg_transparent
--     self:bg_setuper(self.is_bg_transparent, self.is_floating_transparent)
-- end
--
-- return M
-- =========================
